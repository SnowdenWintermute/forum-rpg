...
router.post("/create", (req, res) => {
    const newEquipmentStats = equipmentGenerator(1, "magic")
    ...
    newEquipment.save().then(res.status(200).json({"newEquipment": newEquipment })).catch(err => res.status(400).json(err))
});
