...
export const equipItem = itemId => dispatch => {
  axios
    .put(`/api/characters/equip-item/${itemId}`)
    .then(res => {
      dispatch({
        type: EQUIP_ITEM,
        payload: res.data
...
export const updateStats = () => dispatch => {
  axios
    .put("/api/characters/update-stats")
    .then(res => {
      dispatch({
        type: GET_CHARACTER,
        payload: res.data
...
export const unequipItem = slot => dispatch => {
  axios.put(`/api/characters/unequip/${slot}`).then(res => {
...
export const destroyItem = itemId => dispatch => {
  axios
    .delete(`/api/characters/destroy-item/${itemId}`)
    .then(res => {
